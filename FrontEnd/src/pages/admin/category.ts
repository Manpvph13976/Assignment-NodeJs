    ...
    render: async () => {
        ...
        <div class="flex mt-4 divide-x ml-5">
            ...
            <div class="grow px-4">
                ...
                <table class="table-auto border mt-5 mx-auto w-[80%]">     
                    <thead>
                    <tr>
                        <th class="w-[10%] border">#</th>
                        <th class="w-[30%] border">Tên sản phẩm</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <button class="btn btn-remove ml-4" data-id=${item._id}><svg width="16" height="21" viewBox="0 0 16 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <td class="border">
                                <a href="/category/edit/${item._id}"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
